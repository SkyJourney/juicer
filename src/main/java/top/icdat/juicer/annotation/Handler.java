 ...
 * 链式抓取。<br>
 * handler实例要求含有标有{@link Href}和{@link Parser}
 ...
 * The handler instance requires two methods marked with {@link Href} and
 * {@link Parser} annotations, otherwise a RuntimeException said have no method
